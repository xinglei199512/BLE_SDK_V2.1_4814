 ...
 ****************************************************************************************
 */
static unsigned long l_crc32_table[256];

/*
static const unsigned int l_crc32_table[] = {
 ...
 ****************************************************************************************
 */
unsigned long crc32_calc(unsigned long crc, void* input, unsigned long len)
{
    ...
    byteBuf = (unsigned char*) input;

    for (i = 0; i < len; i++) {
          crc32 = l_crc32_table[(crc32 ^ byteBuf[i]) & 0xFF] ^ (crc32 >> 8);
      }
