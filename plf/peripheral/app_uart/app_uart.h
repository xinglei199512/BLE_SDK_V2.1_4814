...
enum uart_divisor_settings
{
    ...
    UART_BAUDRATE_500000_DIVISOR =  4 ,
    UART_BAUDRATE_460800_DIVISOR = 2,
    UART_BAUDRATE_750000_DIVISOR = 1,
    UART_BAUDRATE_921600_DIVISOR = 1,
    UART_BAUDRATE_1000000_DIVISOR = 2,
    UART_BAUDRATE_1500000_DIVISOR = 1,
...
struct uart_env_tag
{
    ...
    /// tx lock
    periph_lock_t tx_lock;
    /// rx lock
    periph_lock_t rx_lock;
