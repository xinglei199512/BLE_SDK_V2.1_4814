...
/**
 ****************************************************************************************
 * @addtogroup MESH_light_hsl_client_API Mesh light_hsl_client API
 * @ingroup MESH_API
 * @brief Mesh light_hsl_client  API
 *
 * @{
 ****************************************************************************************
 */

#ifndef APP_FREERTOS_MESH_MODEL_LIGHT_MODE_LIGHT_HSL_LIGHT_HSL_CLIENT_H_
#define APP_FREERTOS_MESH_MODEL_LIGHT_MODE_LIGHT_HSL_LIGHT_HSL_CLIENT_H_
...
#define DEF_LIGHT_HSL_CLIENT_MODEL(name,app_key_max) \
    static light_hsl_client_t name;\
    static model_publish_state_t name##_publish_state;\
    static app_key_t *name##bound_key_buf[app_key_max];

#define INIT_LIGHT_HSL_CLIENT_MODEL(name,app_key_max,element_num,sub_list,sub_list_num) \
    mesh_model_init(&name.model.base,LIGHT_HSL_CLIENT_MODEL_ID,true,app_key_max,name##bound_key_buf);\
...
void light_hsl_set_tx(light_hsl_client_t *client, void *msg , uint8_t msg_length, uint16_t dst_addr, uint16_t appkey_global_idx, uint16_t opcode_offset);


#endif /* APP_FREERTOS_MESH_MODEL_LIGHT_MODE_LIGHT_HSL_LIGHT_HSL_CLIENT_H_ */ 
/// @} MESH_light_hsl_client_API
