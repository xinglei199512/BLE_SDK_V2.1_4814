...
static void *qsort_median3(void *array,uint32_t type_size,int (*cmp)(void *,void *),uint32_t left,uint32_t right)
{
    ...
    {
        bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,left),GET_ARRAY_ELMT_PTR(array,type_size,center),type_size);
    }
    if(cmp(GET_ARRAY_ELMT_PTR(array,type_size,left),GET_ARRAY_ELMT_PTR(array,type_size,right))>0)
    {
        bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,left),GET_ARRAY_ELMT_PTR(array,type_size,right),type_size);
    }
    if(cmp(GET_ARRAY_ELMT_PTR(array,type_size,center),GET_ARRAY_ELMT_PTR(array,type_size,right))>0)
    {
        bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,center),GET_ARRAY_ELMT_PTR(array,type_size,right),type_size);
    }
    bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,center),GET_ARRAY_ELMT_PTR(array,type_size,right-1)); //hide pivot
...
void bx_qsort(void *array,uint32_t type_size,int (*cmp)(void *,void *),uint32_t left,uint32_t right)
{
    ...
    if(left<right)
    {
        ...
        while(1)
        {
            ...
            if(i<j)
            {
                bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,i),GET_ARRAY_ELMT_PTR(array,type_size,j));
            }else{
                break;
            }
            bx_swap(GET_ARRAY_ELMT_PTR(array,type_size,i),GET_ARRAY_ELMT_PTR(array,type_size,right - 1));
            bx_qsort(array,type_size,cmp,left, i-1);
            bx_qsort(array,type_size,cmp, i+1,right);
        }
    }
}
